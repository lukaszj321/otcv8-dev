...
| Warstwa                   | Kolor          | `classDef`  |
| :------------------------ | :------------- | :---------- |
| **Core Engine**           | 🟦 Niebieski    | `core`      |
| **Subsystemy**            | 🟩 Zielony      | `subsystem` |
| **Logika Gry & Moduły**   | 🟧 Pomarańczowy | `game`      |
| **User Interface (UI)**   | 🟪 Fioletowy    | `ui`        |
| **Networking & Security** | 🟥 Czerwony     | `netsec`    |
| **Platforma**             | 🔳 Szary        | `platform`  |
...
| Ikona                       | Typ Komponentu         |
| :-------------------------- | :--------------------- |
| ⚙️ `fa-cogs`                 | **Menedżer / Proces**  |
| 🗃️ `fa-database`             | **Dane / Storage**     |
| ⚡ `fa-bolt`                 | **Zdarzenie / Sygnał** |
| 🔌 `fa-plug`                 | **Interfejs / API**    |
| 📄 `fa-file-alt`             | **Plik / Zasób**       |
| ⚠️ `fa-exclamation-triangle` | **Błąd / Ryzyko**      |
