---
title: "Blueprint: events Template"
type: "blueprint"
---
...
This blueprint provides a reusable template for events implementation.

## Structure

```lua
-- Blueprint structure
local eventsTemplate = {
    name = "template",
    version = "1.0",
...
```lua
local template = require('events_template')
