---
title: "Blueprint: assets Template"
type: "blueprint"
---
...
This blueprint provides a reusable template for assets implementation.

## Structure

```lua
-- Blueprint structure
local assetsTemplate = {
    name = "template",
    version = "1.0",
...
```lua
local template = require('assets_template')
