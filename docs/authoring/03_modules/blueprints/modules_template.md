---
title: "Blueprint: modules Template"
type: "blueprint"
---
...
This blueprint provides a reusable template for modules implementation.

## Structure

```lua
-- Blueprint structure
local modulesTemplate = {
    name = "template",
    version = "1.0",
...
```lua
local template = require('modules_template')
