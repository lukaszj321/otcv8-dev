...
:file: ../../_data/01_core/summary.csv
:header-rows: 1
:widths: 30, 30, 40
```
...
:file: ../../_data/01_core/entities.csv
:header-rows: 1
:widths: 40, 20, 40
```
...
- [Diagrams](https://github.com/lukaszj321/otcv8-dev/tree/master/docs/reposzablony/01_core/diagrams)
- [Chapter Index](https://github.com/lukaszj321/otcv8-dev/blob/master/docs/reposzablony/01_core/index.md)
...
*Generated from source data in `docs/reposzablony/01_core/`*
