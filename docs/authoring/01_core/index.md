...
:class: dropdown
Lokalizacja: `../../reposzablony/01_core/datasets/entities.csv`
```
...
:class: dropdown
Lokalizacja: `../../reposzablony/01_core/datasets/summary.csv`
```

```{csv-table} summary
:header-rows: 1
:file: ../../reposzablony/01_core/datasets/summary.csv
:widths: 50,50
```
...
:class: tip
Lokalizacja: `../../reposzablony/01_core/diagrams/architecture.mmd`
```
...
:class: tip
Lokalizacja: `../../reposzablony/01_core/diagrams/flow.mmd`
```

````{mermaid}
:caption: flow
```{include} ../../reposzablony/01_core/diagrams/flow.mmd
```
````

```{admonition} Kod źródłowy (flow.mmd)
:class: dropdown
```{literalinclude} ../../reposzablony/01_core/diagrams/flow.mmd
:language: mermaid
```
```
