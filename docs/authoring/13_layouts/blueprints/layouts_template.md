---
title: "Blueprint: layouts Template"
type: "blueprint"
---
...
This blueprint provides a reusable template for layouts implementation.

## Structure

```lua
-- Blueprint structure
local layoutsTemplate = {
    name = "template",
    version = "1.0",
...
```lua
local template = require('layouts_template')
